...
\]
$a \dots f$ are unknown variables.

We have $s^2$ known points, which means $s^2$ equations. The smallest $s$ that makes sense is 3, so we always have a linear system with more equations than unknown variables.
