...
In the following section, we describe how is the zero--normalized cross--corre\-lation used to analyze the deformation of EBSPs. Algorithm \ref{algo-whole} describes the whole process in pseudocode. 
