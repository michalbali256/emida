...
The discrete Fourier transform \cite{proakis2004digital}
\[
X_k = \sum_{n=0}^{N-1} x_n \cdot e^{-\frac{i2\pi}{N}kn}
\]


cross correlation can be computed using FT

FFT - fast way to compute FT

FFT computes cyclic FT - considers the points a part of periodic fuanciton
\section{Arg max}
