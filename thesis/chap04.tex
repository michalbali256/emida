...
We also measured how much the results between different precisions varied. On average, the shifts differed by 0.005\%. \Cref{float-error} shows more statical characteristics of the error. Whether the the single precision is sufficient depends on physical interpretation.
